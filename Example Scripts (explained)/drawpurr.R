...
niter <- 650 # Number of iterations
...
angle <- 3.4 # angle of mid-segment with the edge
curv <- 2   # Curvature of curves
line_color <- "cornflowerblue" # Color of curves in geom_curve
