...
# set the paths
# make sure you set working directory to current file location before running
IMG_DIR <- "img/"
...
# Choose parameters for your flower - EDIT THESE LINES ONLY UNLESS YOU'RE COMFORTABLE DEBUGGING
